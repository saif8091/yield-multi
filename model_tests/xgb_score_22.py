...
from model_files.xgb_model_func import *
...
results_m = run_xgb_models(X_22_train, y_22_train, X_22_test, y_22_test, feat_lists_m)
results_m.to_csv(dir_name+'/xgb_scores_22_m.csv', index=False)

results_h = run_xgb_models(X_22_train, y_22_train, X_22_test, y_22_test, feat_lists_h)
results_h.to_csv(dir_name+'/xgb_scores_22_h.csv', index=False)

results_misc = run_xgb_models(X_22_train, y_22_train, X_22_test, y_22_test, feat_list_misc)
results_misc.to_csv(dir_name+'/xgb_scores_22_misc.csv', index=False)

print('XGBoost model scores for 2022 saved in ' + dir_name)
